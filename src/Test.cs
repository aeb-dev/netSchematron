...
namespace netSchematron
{
    public class Test
    {
        ...
        [Production("IfExpr: IF [d] Expr [d] ExprSingle [d] ExprSingle")]
        public int IfExpr()
        {
            return 5;
        }
        ...
        [Production("InstanceofExpr: TreatExpr (INSTANCE [d] SequenceType)?")]
        public int InstanceofExpr()
        {
            return 5;
        }

        [Production("TreatExpr: CastableExpr (TREAT [d] SequenceType)?")]
        public int TreatExpr()
        {
            return 5;
        }

        [Production("CastableExpr: CastExpr (CASTABLE [d] SingleType)?")]
        public int CastableExpr()
        {
            return 5;
        }

        [Production("CastExpr: ArrowExpr (CAST [d] SingleType)?")]
        public int CastExpr()
        {
            return 5;
        }
        ...
        [Production("GeneralComp: GCOMP")]
        public int GeneralComp()
        {
            return 5;
        }

        [Production("ValueComp: VCOMP")]
        public int ValueComp()
        {
            return 5;
        }

        [Production("NodeComp: NCOMP")]
        public int NodeComp()
        {
            return 5;
        }

        [Production("SimpleMapExpr: PathExpr (EXCLAMATION PathExpr)*")]
        ...
        [Production("ForwardAxis: FWDAXIS [d]")]
